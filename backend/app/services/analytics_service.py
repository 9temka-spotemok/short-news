"""
Analytics service responsible for calculating metrics, impact scores, and knowledge graph edges.
"""
...
class AnalyticsService:
    ...
    # Weight configuration for impact score calculations
    ...
    def _is_related(
        ...
        if delta > 48 * 3600:  # 48 hours window
            return False
